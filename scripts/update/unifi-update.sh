...
get_mongodb_org_v() {
  mongodb_org_v="$("$(which dpkg)" -l | grep "mongodb-org-server\\|mongodb-server$\\|mongodb-10gen\\|mongod-armv8\\|mongod-amd64" | grep -i "^ii\\|^hi\\|^ri\\|^pi\\|^ui" | sed '/tool/d' | awk '{print $3}' | sed 's/\.//g' | sed 's/.*://' | sed 's/-.*//g' | sed 's/+.*//g' | sort -V | tail -n 1)"
}
...
if [[ -d "/usr/lib/unifi/logs/" ]]; then
  ...
  if [[ "${application_up}" == 'true' ]]; then
    if [[ "$(du -b "/usr/lib/unifi/logs/mongod.log" 2> /dev/null | awk '{print$1}')" -gt "5368709120 " ]]; then grep_matches="-m 2"; fi
  else
...
if "$(which dpkg)" -l mongodb-org-server 2> /dev/null | awk '{print $1}' | grep -iq "^ii\\|^hi\\|^ri\\|^pi\\|^ui"; then
  ...
  if [[ "${installed_mongodb_org_version_check::2}" -ge '44' && "$(dpkg-query --showformat='${Version}' --show mongodb-org-server | sed -e 's/.*://' -e 's/-.*//g' | awk -F. '{print $3}')" -ge "19" ]]; then if [[ "${glennr_mongod_compatible}" == "true" ]]; then unsupported_database_version_change="true"; fi; fi
  ...
  if [[ "${installed_mongodb_version_check::2}" -ge '44' && "$(dpkg-query --showformat='${Version}' --show mongodb-server | sed -e 's/.*://' -e 's/-.*//g' | awk -F. '{print $3}')" -ge "19" ]]; then if [[ "${glennr_mongod_compatible}" == "true" ]]; then unsupported_database_version_change="true"; fi; fi
...
if [[ "${first_digit_unifi}" == '5' && "${second_digit_unifi}" =~ ^(0|1|2|3|4|5)$ ]]; then
  ...
  echo -e " [   ${WHITE_R}17${RESET}  ]  |  9.0.108"
  if [[ "${release_stage}" == 'RC' ]]; then
  ...
  case "$UPGRADE_VERSION" in
      ...
      17)
        unifi_update_start
        unifi_firmware_requirement
        application_version="9.0.108-u598f2io2a"
        application_upgrade_releases
        unifi_update_finish;;
      18)
        if [[ "${release_stage}" == 'RC' ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "5.6.40" || "${unifi}" == "5.6.41" ]]; then
    ...
    echo -e " [   ${WHITE_R}16${RESET}  ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
    ...
    echo -e " [   ${WHITE_R}15${RESET}  ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "6.5.55" ]]; then
    ...
    echo -e " [   ${WHITE_R}14${RESET}  ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "7.0.25" ]]; then
    ...
    echo -e " [   ${WHITE_R}13${RESET}  ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "7.1.68" ]]; then
    ...
    echo -e " [   ${WHITE_R}12${RESET}  ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "7.2.97" ]]; then
    ...
    echo -e " [   ${WHITE_R}11${RESET}  ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "7.3.83" ]]; then
    ...
    echo -e " [   ${WHITE_R}10${RESET}  ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "7.4.162" ]]; then
    ...
    echo -e " [   ${WHITE_R}9${RESET}   ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "7.5.187" ]]; then
    ...
    echo -e " [   ${WHITE_R}8${RESET}   ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
      echo -e " [   ${WHITE_R}9${RESET}   ]  |  ${rc_version_available}"
      echo -e " [   ${WHITE_R}10${RESET}  ]  |  Cancel\\n\\n"
    else
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "8.0.28" ]]; then
    ...
    echo -e " [   ${WHITE_R}7${RESET}   ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "8.1.127" ]]; then
    ...
    echo -e " [   ${WHITE_R}6${RESET}   ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "8.2.93" ]]; then
    ...
    echo -e " [   ${WHITE_R}5${RESET}   ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "8.3.32" ]]; then
    ...
    echo -e " [   ${WHITE_R}4${RESET}   ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "8.4.62" ]]; then
    ...
    echo -e " [   ${WHITE_R}3${RESET}   ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "8.5.6" ]]; then
    ...
    echo -e " [   ${WHITE_R}2${RESET}   ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
...
##########################################################################################################################################################################
  ...
  if [[ "${unifi}" == "8.6.9" ]]; then
    unifi_version='8.6.9'
    echo -e " [   ${WHITE_R}1${RESET}   ]  |  9.0.108"
    if [[ "${release_stage}" == 'RC' ]]; then
